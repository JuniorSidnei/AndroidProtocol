...
namespace GameToBeNamed.Character.NPC {
    ...
    public class WarriorTerminalNpcBehavior : NpcBehavior {
        ...
        public void Update () {
            ...
            if (m_player.GetButtonDown("Action") && m_npcState != NPCstates.None) {
                ChangeNPCState();
            }
...
//            }
        ...
        private void OnTriggerEnter2D(Collider2D other) {
            ...
            if (((1 << other.gameObject.layer) & PlayerLayer) == 0 || !other.gameObject.tag.Equals(PlayerTag)) {
                return;
            }
